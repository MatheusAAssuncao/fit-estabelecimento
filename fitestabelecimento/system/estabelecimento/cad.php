...
if($idEstabelecimento){
	...
	if($numRows){
		$cnpj = mysql_result($resultado, 0, 'cnpj');
		$razaoSocial = mysql_result($resultado, 0, 'razaoSocial');
		$nomeFantasia = mysql_result($resultado, 0, 'nomeFantasia');
		$email = mysql_result($resultado, 0, 'email');
		$endereco = mysql_result($resultado, 0, 'endereco');
		$cidade = mysql_result($resultado, 0, 'cidade');
		$estado = mysql_result($resultado, 0, 'estado');
		$telefone = mysql_result($resultado, 0, 'telefone');
		$categoria = mysql_result($resultado, 0, 'idCategoria');
		$status = mysql_result($resultado, 0, 'status');
		$dataCadastro = mysql_result($resultado, 0, 'dataCadastro');
...
<html lang="pt_br">
  ...
  <body>
	...
	<div class="container">
    <center><h3>Alterar Estabelecimento</h3></center>
	...
	<div class="row">
		...
		<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
			<div class="form-group">
				...
				<input type="text" class="form-control" style="text-transform:uppercase;" value="<?=$nomeFantasia?>" name="nomeFantasia" id="nomeFantasia">
			</div>
		</div>
		<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
			<div class="form-group">
				<label for="email">E-mail:</label>
				<input type="text" class="form-control" style="text-transform:uppercase;" value="<?=$email?>" onBlur="ValidaEmail(this);" name="email" id="email">
			</div>
		</div>
		<div class="col-md-2 col-lg-2"></div>
	</div>
	...
	<div class="row">
		...
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
			<div class="form-group">
				...
				<input type="text" class="form-control" style="text-transform:uppercase;" value="<?=$endereco?>" name="endereco" id="endereco">
			</div>
		</div>
		<div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
			<div class="form-group">
				<label for="cidade">Cidade:</label>
				<input type="text" class="form-control" style="text-transform:uppercase;" value="<?=$cidade?>" name="cidade" id="cidade">
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
			<div class="form-group">
				...
				<input type="text" class="form-control" onKeyDown="Mascara(this, mtel);" value="<?=$telefone?>" maxlength="15" name="telefone" id="telefone">
			</div>
		</div>
		<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
			<div class="form-group">
				...
				while($row = mysql_fetch_array($resultado, MYSQL_ASSOC)){
					if($row['idCategoria'] == $categoria)
						echo "<option selected value='$row[idCategoria]'>$row[nome]</option>";
					else
	...
	<div class="row">
		...
		<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
			<div class="form-group">
				...
				<input type="text" class="form-control" readonly value="<?=$dataCadastro?>" name="dataCadastro" id="dataCadastro">
			</div>
		</div>
		<div class="col-md-2 col-lg-2"></div>
	</div>
	...
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		<button type="submit" onclick="return validar2()" class="btn btn-default">Alterar</button>
	</div>
	<div class="col-md-2 col-lg-2"></div>
	</div>
